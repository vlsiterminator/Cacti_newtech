  ...
  is_main_mem(is_main_mem_), cell(), is_valid(false)
{
  ...
  //cout<<"wire_pitch="<<g_tp.wire_local.pitch<<endl;
  //cout<<"wire_R/um="<<g_tp.wire_local.R_per_um<<endl;
...
/*
cout<<"num_do_b_subbank="<<num_do_b_subbank<<endl;
cout<<"num_do_b_mat"<<num_do_b_mat<<endl;
*/
cout<<"num_act_mats_hor_dir=" << num_act_mats_hor_dir <<endl;
cout<<"num_mats_h_dir=" << num_mats_h_dir <<endl;
