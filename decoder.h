...
class Decoder : public Component
{
  public:
    ...
    //For observing temporary data in Decoder. Won't have any impact on the outputs. Added by Ningxi.
    double tmp_delay[MAX_NUMBER_GATES_STAGE];
    double tmp_power[MAX_NUMBER_GATES_STAGE];
    double tmp_risetime[MAX_NUMBER_GATES_STAGE];
    double delay;
    powerDef power;
    bool   fully_assoc;
    bool   is_dram;
